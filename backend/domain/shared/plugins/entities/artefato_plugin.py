...
class ArtefatoPlugin:
    ...
    Atributos:
        ...
        atualizado_em (datetime): Data e hora da última atualização do artefato.
        criado_por (Optional[str]): Usuário que criou o artefato.
        atualizado_por (Optional[str]): Usuário que atualizou o artefato pela última vez.
