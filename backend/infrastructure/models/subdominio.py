...
class Subdominio(models.Model):
    ...
    do contexto de um site específico, garantido pela combinação de site e nome.
    ...
    site = models.ForeignKey(CustomSite, on_delete=models.CASCADE, related_name='subdominios')
    ...
    class Meta:
        ...
        Define a combinação única de site e nome, garantindo que cada subdomínio 
        seja único dentro de um site.
        """
        unique_together = ('site', 'nome')
